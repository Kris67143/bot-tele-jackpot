...
# === Gửi Telegram với custom emoji và bold ===
...
def monitor():
    ...
    while True:
        try:
            ...
            # cập nhật trạng thái tất cả game
